...
This document explains how `plane-game` is aligned with the current WeChat minigame project model.
...
- `src/entities.js`, `src/audio.js`, and `src/settings.js` provide gameplay support modules
...
- a dedicated cover screen with title, slogan, briefing text, plane preview, and author credit
- touch drag movement
- auto fire
