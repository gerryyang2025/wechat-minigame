...
var FONT_PATH = 'fonts/ma-shan-zheng-home.ttf';
...
function setGlobalFontFamily(fontFamily) {
  if (typeof GameGlobal !== 'undefined') {
    GameGlobal.__planeGameCoverFontFamily = fontFamily;
  }
}
...
function getCachedFontFamily() {
  ...
  if (typeof GameGlobal !== 'undefined' && GameGlobal.__planeGameCoverFontFamily) {
    cachedFontFamily = GameGlobal.__planeGameCoverFontFamily;
  }
