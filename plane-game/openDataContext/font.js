...
function getCachedFontFamily() {
  ...
  if (typeof GameGlobal !== 'undefined' && GameGlobal.__planeGameSubFontFamily) {
    cachedFontFamily = GameGlobal.__planeGameSubFontFamily;
  }
...
function ensureLoaded() {
  ...
  if (typeof GameGlobal !== 'undefined') {
    GameGlobal.__planeGameSubFontFamily = cachedFontFamily;
  }
