...
var FONT_PATH = 'fonts/supercell-magic.ttf';
...
function setGlobalFontFamily(fontFamily) {
  if (typeof GameGlobal !== 'undefined') {
    GameGlobal.__defenseGameFontFamily = fontFamily;
  }
}
...
function getCachedFontFamily() {
  ...
  if (typeof GameGlobal !== 'undefined' && GameGlobal.__defenseGameFontFamily) {
    cachedFontFamily = GameGlobal.__defenseGameFontFamily;
  }
